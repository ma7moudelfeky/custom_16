...
class SaleOrderLine(models.Model):
    ...
    @api.depends('product_id', 'product_uom', 'product_uom_qty', 'discount_1', 'discount_2', 'discount_3', 'type_1', 'type_2')
    ...
    @api.onchange('product_id', 'product_uom', 'product_uom_qty', 'discount_1', 'discount_2', 'discount_3', 'type_1', 'type_2')
    def _onchange_product_id_warning(self):
        """ Override _onchange_product_id_warning """
        res = super(SaleOrderLine, self)._onchange_product_id_warning()
        for rec in self:
            if rec.order_id.partner_id.parent_id:
                rec.discount_2 = rec.order_id.partner_id.parent_id.discount_1
                rec.discount_3 = rec.order_id.partner_id.parent_id.discount_2
                rec.type_1 = rec.order_id.partner_id.parent_id.type_1
                rec.type_2 = rec.order_id.partner_id.parent_id.type_2
            elif rec.order_id.partner_id:
        ...
        for rec in self:
            ...
            if rec.order_line:
                ...
                if line_vals:
                    ...
                    rec.credit_note_id = credit_note_id.id